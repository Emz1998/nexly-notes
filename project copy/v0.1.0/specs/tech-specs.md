    ...
    content: [
      {
        type: "heading",
        attrs: { level: 2 },
        content: [{ type: "text", text: "Nursing Diagnosis" }],
      },
    ...
    content: [
      {
        type: "heading",
        attrs: { level: 3 },
        content: [{ type: "text", text: "Mean Arterial Pressure (MAP)" }],
      },
      {
        type: "paragraph",
        content: [{ type: "text", text: "Formula: MAP = (SBP + 2×DBP) / 3" }],
      },
      {
        type: "paragraph",
        content: [
