...
def check_file(file_path: str, file_type: Literal["code","plan"]) -> bool:
    ...
    return file_path.endswith(PLAN_FILE_NAME) if file_type == "plan" else file_path.endswith(CODE_EXTENSIONS)
    
def trigger_review(file_path: str, review_type: Literal["research", "code", "plan" ]) -> dict:
