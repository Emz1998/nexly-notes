...
*Core Concept:* Three distinct modes optimized for different stages of the note-taking and learning workflow
...
*Purpose:* Reduce typing load and catch missed terminology in real-time
...
*Purpose:* Never lose work, enable future features
...
*Purpose:* Instant visibility into what changed since last save for confident editing
...
*Purpose:* Automatically identify exam-relevant terms and professor emphasis cues
...
*Purpose:* Make mode selection explicit and intentional when revisiting notes
...
*Purpose:* Ensure students understand workflow immediately
...
*Purpose:* Find and open notes quickly
